...
<header onmouseover="handleHover1()">
    <h1> Filtro de Funcionarios Todas as Regionais <h1>
</header>
<nav>
        <a href="#">Home</a>
        <a href="#">Sobre</a>
...
$queryw = "SELECT ID AS ID,Nome,Funcao,Regional,Ramal,Celular,Email FROM servidorestodos WHERE Nome LIKE '$var1%' AND Funcao LIKE '$var2%';";
